...
public class Book_Setup {
    ...
    int Book_ID = -134, Book_Quantity = 0, Book_Available = 0;
    ...
    public Book_Setup(int ID, String Name, String Author, int Quantity, int Available) {
        this.Book_ID = ID;
    ...
    Book_Setup input_book(int ID) {
        ...
        Book_ID = ID;
        return new Book_Setup(Book_ID, Book_Name, Author, Book_Quantity, Book_Available);
    }
